...
class Record extends Data {
  ...
  static List<Record> dummyList() {
    Record r1 = Record(
        sampleName: "Pesok 20-11-11",
        recordDateTime: DateTime(2021, 11, 11),
        measurements: Message.dummyList());
    Record r2 = Record(
        sampleName: "peschannik 20-01-09",
        recordDateTime: DateTime(2021, 1, 9),
        measurements: Message.dummyList());
    Record r3 = Record(
        sampleName: "Ugol 21-05-04",
        recordDateTime: DateTime(2021, 5, 4),
        measurements: Message.dummyList());
